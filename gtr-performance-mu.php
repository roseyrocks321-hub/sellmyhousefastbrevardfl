...
// 12. APPEND RELATED LINKS TO BLOG POST CONTENT
add_filter('the_content', function($content) {
    if (is_admin() || !is_single()) return $content;
    $related_link = '<p class="gtr-related-link"><strong>Related:</strong> <a href="https://goldenticketrealty.com">Sell Your House Fast in Melbourne</a></p>';
    return $content . "\n" . $related_link;
}, 20);
